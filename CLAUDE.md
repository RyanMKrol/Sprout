...
This project runs with **`REQUIRE_CI=0`** and **no `.github/workflows/`** — GitHub is used only
as a git remote, it never runs any compute. The merge gate is the **local Definition of Done**
