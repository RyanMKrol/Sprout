...
| Pothos | Epipremnum aureum | evenlyMoist | 7 / 5–14 | Seed dataset (T003) — RHS / The Sill: forgiving aroid, let the top 2 cm dry then water; standard 1–2 week cadence. (Everyday-name alias of Golden Pothos; both ship so the picker offers the common name.) |
| Snake Plant | Dracaena trifasciata | driesOut | 14 / 10–28 | Seed dataset (T003) — RHS: drought-tolerant succulent-leaved plant; let the compost dry right out between waterings → long interval. |
| Monstera deliciosa | Monstera deliciosa | evenlyMoist | 9 / 6–14 | Seed dataset (T003) — RHS / The Sill: water when the top 2–3 cm dry; keep evenly moist in growth, sparingly in winter → medium interval. |
| Boston Fern | Nephrolepis exaltata | staysMoist | 4 / 2–7 | Seed dataset (T003) — RHS: moisture-loving fern, keep the compost consistently damp and never let it dry out → short interval. |
| Peace Lily | Spathiphyllum wallisii | evenlyMoist | 6 / 4–10 | Seed dataset (T003) — RHS: keep evenly moist, water when the surface dries (wilts as a clear thirst signal) → medium interval. |
| Monstera adansonii | Monstera adansonii | evenlyMoist | 8 / 5–12 | T225 (gap-fill batch 1) — Patch lists this popular plant by its botanical name; the care profile already ships as "Swiss Cheese Vine" (same numbers), so this is a deliberate display-name alias (Pothos / Golden Pothos precedent) letting the picker find it. |
| Bird of Paradise | Strelitzia reginae | evenlyMoist | 7 / 5–12 | T225 — RHS / Patch: large thirsty leaves in growth; keep evenly moist spring–summer, let the surface dry between waterings, much drier in winter → medium interval. New genus. |
| Giant White Bird of Paradise | Strelitzia nicolai | evenlyMoist | 8 / 6–14 | T225 — Hortology / Patch: bigger and more drought-tolerant than S. reginae; water when the top few cm dry → slightly longer interval. |
| English Ivy | Hedera helix | evenlyMoist | 6 / 4–9 | T225 — RHS / DWH most-searched: keep lightly moist, water when the surface starts to dry; dislikes both drought and waterlogging → medium interval. New genus. |
| Norfolk Island Pine | Araucaria heterophylla | evenlyMoist | 7 / 5–12 | T225 — RHS: keep evenly moist in growth, let the top 2–3 cm dry; resents drying out fully (drops needles) → medium interval. New genus. |
| Fishbone Cactus | Disocactus anguliger (syn. Epiphyllum anguliger) | evenlyMoist | 9 / 6–14 | T225 — RHS / Hortology: forest (epiphytic) cactus treated like Christmas cactus — water when the top third dries, never bone-dry → medium interval. |
| Living Stones | Lithops spp. | driesOut | 21 / 14–35 | T225 — RHS: extreme xerophyte; water very sparingly only in active growth and not at all during leaf-renewal dormancy → longest interval in the set. |
| Calathea Network | Goeppertia kegeljanii 'Network' (Calathea musaica) | staysMoist | 4 / 3–6 | T225 — Patch / Hortology: calathea anchor; keep consistently moist with soft water, never let it dry out → short interval. |
| Calathea White Fusion | Calathea lietzei 'White Fusion' | staysMoist | 4 / 3–6 | T225 — Hortology: variegated, thirsty and fussy; keep evenly moist with soft water and high humidity → short interval. |
| Calathea Medallion | Goeppertia veitchiana 'Medallion' | staysMoist | 4 / 3–6 | T225 — Hortology: calathea anchor; keep moist, never soggy or bone-dry → short interval. |
| Philodendron Gloriosum | Philodendron gloriosum | evenlyMoist | 8 / 5–12 | T225 — Patch: crawling velvet-leaf aroid; aroid anchor, water when the top 2–3 cm dry → medium interval. |
| Alocasia Frydek | Alocasia micholitziana 'Frydek' | evenlyMoist | 7 / 5–10 | T225 — Hortology: green-velvet alocasia; keep evenly moist in growth, let the surface dry, sensitive to over/under-watering → medium interval. |
